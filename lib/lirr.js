...
class LIRRProvider extends Provider {
  ...
  _getTrainDestination(train) {
    var flags = this._getTrainInfoFlags(train);
    return destinations[train.DEST] + this._stringifyFlags(flags);
  }

  _getTrainInfoFlags(train) {
    var flags = []
  ...
  _processTrain(train) {
    return new Promise((resolve, reject) => {
      ...
      train.DESTINATION = this._getTrainDestination(train);
